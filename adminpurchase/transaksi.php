                            ...
                            <div class="box">
                                ...
                                <div class="box-body table-responsive">
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
										<?php 
										$show=mysql_query("SELECT DISTINCT * from transaksi where status='0' GROUP BY id_supplier");
										$i=0;
										...
										$totharga0=mysql_query("SELECT SUM(HARGA) as total from pemesanan where id_pemesanan in (select id_pemesanan from transaksi where id_transaksi='$id')");
										$totharga1=mysql_fetch_array($totharga0);
							...
							<div class="box">
                                ...
                                <div class="box-body table-responsive">
                                    <table id="example3" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
										<?php 
										$show=mysql_query("SELECT DISTINCT * from transaksi where status='1' GROUP BY id_supplier");
										$i=0;
										while($data=mysql_fetch_array($show)){
										$i++;
										$id=$data['id_transaksi'];
