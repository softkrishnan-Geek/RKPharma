            ...
            <aside class="right-side">
                ...
                <section class="content">
                        ...
                        <table class="table table-bordered table-striped">
                            <tr><td>ID</td><td>Nama</td><td>Jenis</td><td>Jumlah</td><td>Satuan</td><td>Supplier</td><td>Tanggal</td><td>Status</td></tr>
                        <?php
                        include "konekdb.php";
                        ...
                        echo "<tr><td>$id</td><td>$nama</td><td>$jenis</td><td>$jumlah</td><td>$satuan</td><td>$supplier</td><td>$tanggal</td>";
